...
export class UserController {
    ...
    getUserPaginate(@Req() req: Request): Promise<users[]> {
        ...
        return this.userService.userPagination(parseInt(pageIndex), parseInt(pageSize))
    }
    ...
    @Put(":user_id")
    updateUserByID(@Param("user_id") user_id: string,@Body() user: User): Promise<users>{
    ...
    uploadUserImage(@Param("user_id") user_id: string, @UploadedFile() file: Express.Multer.File): any {
