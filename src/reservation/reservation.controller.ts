...
export class ReservationController {
    ...
    @Put(":reserve_id")
    updateReserveByID(@Param("reserve_id") reserve_id: string,@Body() reserve:Reservation): Promise<reserve>{
    ...
    @ApiParam({ name: "reserve_id" })
    @Delete(":reserve_id")
    deleteReserveByID(@Param("reserve_id") reserve_id: string): Promise<ReserveResultDto> {
